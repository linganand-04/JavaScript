...
while (dice===6) {
  console.log(`You roll the value ${dice}`);
  dice = Math.trunc(Math.random() * 6)+1;
  if(dice!==6){
    console.log(`Your roll extact value ${dice} so..END`);
...
3. Use the 'calcTip' function we wrote before (no need to repeat) to calculate tips and total values (bill + tip) for every bill value in the bills array. Use a for loop to perform the 10 calculations! Test data: 22, 295, 176, 440, 37, 105, 10, 1100, 86 and 52 
